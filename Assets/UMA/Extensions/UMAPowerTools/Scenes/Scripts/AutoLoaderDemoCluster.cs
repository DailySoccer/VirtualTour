...
{
	public class AutoLoaderDemoCluster : MonoBehaviour
	{
		public float range;
		public int characters;
		public AutoLoaderDemoScript demoScript;
		...
		{
			Destroy(umaData.animator.GetComponent<CapsuleCollider>());
			Destroy(umaData.animator.GetComponent<Rigidbody>());
		}
