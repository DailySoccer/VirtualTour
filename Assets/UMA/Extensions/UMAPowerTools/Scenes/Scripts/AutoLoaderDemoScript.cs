...
{
	public class AutoLoaderDemoScript : MonoBehaviour
	{
		...
		public AutoLoaderDemoCluster[] clusters;
		...
		public void More()
		{
			if (!controller.CreatePaused && controller.IsIdle)
			{
				...
				{
					var oldValue = cluster.characters;
		...
		private void BuildGUIStrings()
		{
			...
			{
				charNumber = string.Format("Total visible {0}", totalVisible);
			}
